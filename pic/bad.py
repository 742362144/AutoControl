...
bar_width = 0.8
# {'/', '\', '|', '-', '+', 'x', 'o', 'O', '.', '*'}
b1 = plt.bar(1, y1, bar_width, color='green', hatch='//', label='normal')
b2 = plt.bar(2, y2, bar_width, color='red', hatch='\\\\', label='system overload')
plt.xticks([])
...
# plt.text(1, -1800, "Math calculate", fontdict=text_font, zorder=4)
